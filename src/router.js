...
const router = (request, response) => {
  ...
  if (endpoint === "") {
    ...
    // request.on("end", () => {
    //   const model = queryString.parse(data).model;
    //   const platenum = queryString.parse(data).platenum;
    //   const imgurl = queryString.parse(data).imgurl;

    //   postData(model, platenum, imgurl, (err, res) => {
    //     if (err) {
    //       response.writeHead(500, "Content-Type: text/html");
